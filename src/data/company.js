...
export const company = {
  ...
  founded: 2022,
  email: "info@neuronedge.in",
  phone: "+91 73594 99087",
  address: "ORCHID COMPLEX, A112, Chhapi, Gujarat 385210",
  offices: ["Gujarat, India"],
  socials: [
...
export const services = [
  {
    ...
    short: "Modern, high-performance SaaS platforms, enterprise portals, and data-dense web applications engineered for speed, scalability, and uptime.",
    description: "We architect full-stack web applications designed for demanding real-world workloads. From server-side rendered frontends to high-throughput backend APIs, we prioritize sub-millisecond database queries, optimized asset delivery, and resilient state management.",
    tech: ["React 19", "Next.js", "Django", "FastAPI", "Node.js (Fastify)", "PostgreSQL", "Redis", "TailwindCSS"],
    bullets: [
      "Full-Stack SaaS Platforms & Multi-Tenant Enterprise Portals",
      "REST & GraphQL API Engineering with OpenAPI/Swagger Documentation",
      "Server-Side Rendering (SSR) & Edge-Cached Dynamic Content",
      "Real-Time Live Data Streams & WebSockets (Socket.IO / Engine.IO)",
      "Time-Ordered UUIDv7 Relational Schemas & High-Speed Redis Caching"
    ],
  ...
  },
  {
    ...
    short: "Cross-platform iOS and Android applications built for fluid 60fps performance, offline-first reliability, and seamless hardware integration.",
    description: "We build production mobile applications using modern frameworks that provide native-level fluidity and unified cross-platform codebases. We solve complex mobile challenges including local SQLite caching, transactional outbox push workers, and real-time sensor tracking.",
    tech: ["React Native", "Expo SDK 54", "Flutter", "Dart", "Expo SQLite", "Zustand", "Expo SecureStore", "Expo Push API"],
    bullets: [
      "Cross-Platform iOS & Android Engineering with Single Codebase Efficiency",
      "Offline-First Architecture with Local SQLite Engines & Auto-Sync",
      "Hardware Integrations: GPS Geofencing, Camera Barcode/QR Scanning & Biometrics",
      "Transactional Push Notification Workers with Exponential Retry Backoff",
      "Secure Hardware-Backed Token Storage & Fast Store Approval Workflows"
    ],
  ...
  },
  {
    ...
    icon: "cloud",
    title: "Cloud & DevOps",
    short: "Resilient cloud infrastructure, custom Linux VPS server setup from scratch, automated CI/CD pipelines, domain mapping, and FinOps spend optimization.",
    description: "We design, provision, and maintain reliable production server environments. From hyperscale clouds (AWS/GCP) to dedicated bare-metal and custom Linux VPS instances configured from scratch, we manage the entire hosting lifecycle: reverse proxies, SSL security, systemd daemonization, and DNS/domain routing.",
    tech: ["AWS", "GCP", "Linux VPS (Ubuntu)", "Nginx", "Cloudflare", "Certbot SSL", "Docker", "GitHub Actions", "Upstash QStash"],
    bullets: [
      "Custom Linux VPS Setup from Scratch (Ubuntu/Debian, Nginx, Gunicorn/PM2, Systemd, UFW Firewalls & SSH Hardening)",
      "Domain Management & DNS Mapping (Cloudflare CDN/WAF, A/CNAME Routing, Wildcard SSL via Certbot)",
      "Cloud Migration, Multi-AZ Architecture & High Availability Topologies on AWS & GCP",
      "Worker-Free Serverless Event Scheduling (Upstash QStash Webhooks)",
      "Infrastructure-as-Code (Terraform) & Automated GitHub Actions CI/CD Deployment Pipelines"
    ],
  ...
  },
  {
    ...
    short: "Production-grade Generative AI, custom LLM integrations, RAG pipelines, MCP servers, and agentic workflows embedded directly into your software.",
    description: "We specialize in production-grade Generative AI architectures rather than basic chat wrappers. We architect intelligent agent systems using Model Context Protocol (MCP) servers, custom plugins, execution hooks, robust RAG pipelines with vector databases, and deterministic evaluation harnesses (evals) to deliver reliable, high-speed, cost-optimized AI solutions.",
    tech: ["OpenAI API", "Anthropic Claude", "Google Gemini", "MCP Servers", "RAG & Vector DBs", "Agent Plugins & Hooks", "LangChain", "LlamaIndex", "Pinecone", "Qdrant", "ChromaDB"],
    bullets: [
      "Enterprise LLM API Integrations (OpenAI, Claude, Gemini & Self-Hosted Models)",
      "Model Context Protocol (MCP) Server Development, Custom Tool Schemas & Hooks",
      "Retrieval-Augmented Generation (RAG) with Vector Databases (Pinecone, Qdrant, ChromaDB)",
      "Autonomous Agentic Workflows, Custom Tool Plugins & Multi-Step Function Calling",
      "Pre-Deployment Prompt Evals, Semantic Caching & Token Cost Optimization"
    ],
  ...
  },
  {
    ...
    icon: "pen",
    title: "UI/UX Design",
    short: "Research-backed user experiences, accessible interaction design, and scalable design token systems that bridge design and code.",
    description: "We design digital interfaces that are visually striking, intuitively navigable, and engineered for high conversion. We establish multi-theme semantic design token architectures that ensure consistent implementation across web and mobile platforms.",
    tech: ["Figma", "Design Tokens", "Framer Motion", "Radix UI", "TailwindCSS", "Storybook", "WCAG 2.2 AA"],
    bullets: [
      "Interactive User Journey Mapping, Wireframing & High-Fidelity Prototyping",
      "Multi-Theme Semantic Design Token Architectures (Dark/Light Modes)",
      "Comprehensive Design Systems with Reusable Component Libraries",
      "WCAG 2.2 AA/AAA Accessibility Compliance & Usability Testing",
      "Frictionless Developer Handoff with Tokenized Design-to-Code Specs"
    ],
  ...
  },
  {
    ...
    short: "High-throughput data pipelines, real-time analytics aggregation, and high-density executive command dashboards.",
    description: "We build data architectures that transform disparate transactional logs into actionable intelligence. We design automated rollup engines, partition-pruned relational warehouses, and low-latency visualization platforms.",
    tech: ["PostgreSQL 16", "Redis Cache", "ClickHouse", "Python", "Pandas", "Recharts", "Upstash"],
    bullets: [
      "High-Throughput ETL & Event Streaming Pipelines",
      "Compound Indexing, Partition Pruning & Time-Series Aggregations",
      "Automated Daily & Monthly Ledger Rollups with Background Reconciliation",
      "High-Density Command Dashboards & Interactive Visual Analytics (Recharts)",
      "Granular Role-Based Access Control (RBAC) & Audit Logging Pipelines"
    ],
  ...
  },
  {
    ...
    short: "End-to-end automated test suites, performance load profiling, API contract verification, and zero-flakiness CI testing gates.",
    description: "Quality is engineered into our delivery cycle from sprint zero. We implement automated end-to-end regression suites, p99 concurrency stress tests, and automated CI test quarantines that prevent broken builds from ever reaching production.",
    tech: ["Playwright", "Cypress", "PyTest", "Jest", "Locust", "Postman / Newman", "GitHub Actions CI"],
    bullets: [
      "End-to-End Browser Automation & Cross-Device Test Suites",
      "REST & GraphQL API Automated Contract Testing & Assertion Suites",
      "Concurrency Load & Stress Profiling for p95/p99 Latency Verification",
      "Automated CI/CD Regression Gates & Flaky Test Quarantine Policies",
      "Security Vulnerability Static Analysis (SAST) & Dependency Audits"
    ],
  ...
  },
  {
    slug: "consulting",
    icon: "compass",
    title: "IT Consulting & Architecture Advisory",
    short: "Technology roadmap strategy, deep architectural reviews, performance bottleneck profiling, and dedicated engineering augmentation.",
    description: "We advise leadership teams and engineering organizations on high-stakes technology decisions. We conduct thorough architectural audits to diagnose latency bottlenecks, eliminate technical debt, and score build-versus-buy decisions honestly.",
    tech: ["Enterprise Architecture", "Distributed Systems", "OpenTelemetry", "Microservices & Modular Monoliths", "Agile Execution"],
    bullets: [
      "Deep Architectural Reviews & Production Readiness Audits",
      "Full-Stack Bottleneck Profiling (Network, CDN, Database, Serialization & Pool Sizing)",
      "Build vs. Buy vs. Wait Honest Strategic Scoring & Total Cost of Ownership (TCO) Analysis",
      "Technical Debt Remediation Roadmaps & Modernization Plans",
      "Dedicated Engineering Pods & Team Scaling Augmentation"
    ],
...
export const milestones = [
  { year: "2022", text: "NeuronEdge established by two engineer brothers following completion of an MSc in Computer Science in Bangalore. Began architecting scalable web and mobile software." },
  { year: "2023", text: "Gained enterprise engineering experience at multinational corporations (MNCs) while delivering initial full-stack client platforms." },
  { year: "2024", text: "Expanded cross-platform mobile (React Native & Flutter) and distributed backend architectures with sub-50ms latency standards." },
  { year: "2025", text: "Engineered production AI/ML pipelines (LLMs, Computer Vision) and delivered landmark platforms including Banas Water Logistics, Rahbar Spiritual Suite, and Arya Taray Foundation." },
  { year: "2026", text: "Delivering high-performance digital products, intelligent AI automation, and custom software for clients worldwide." },
];
...
export const testimonials = [
  {
    quote: "NeuronEdge engineered our full mobile social ecosystem with vertical reels and creator monetization. The app runs silky smooth at 60fps and our creator community loves the instant gifting mechanics.",
    name: "Uddesh Singh",
    role: "CEO",
    org: "Starfomo"
  },
  {
    quote: "They delivered our platform with exceptional speed and architectural precision. From responsive UI design to low-latency backend APIs, NeuronEdge acts like an elite internal engineering team.",
    name: "Pushpendra Singh",
    role: "CEO",
    org: "Zolemate"
  },
  {
    quote: "Banas Water automated our entire field delivery, QR verification, and monthly billing cycles. Manual disputes dropped to zero and our route drivers save hours every single day.",
    name: "Zahir Kadiwal",
    role: "Business Owner",
    org: "Banas Water Co."
  }
...
export const faqs = [
  {
    q: "How do we get started and how fast can development begin?",
    a: "We begin with an initial technical discovery session to understand your product goals, architectural constraints, and timeline. Within 48 hours, we deliver a scoped roadmap and sprint plan, typically kicking off active development within 1 to 2 weeks."
  },
  {
    q: "Can you work with our existing codebase and technology stack?",
    a: "Absolutely. Whether your stack is Next.js, React Native, Flutter, Django, Python/FastAPI, or Node.js, we conduct an architecture audit, establish automated testing and CI/CD pipelines, and build modular features directly into your existing infrastructure without unnecessary rewrites."
  },
  {
    q: "How do you approach AI/ML and LLM feature integrations?",
    a: "We engineer production-grade AI systems rather than fragile wrappers. This includes robust evaluation sets (evals) before prompt changes, latency-optimized RAG architectures with vector databases, computer vision edge pipelines, and deterministic caching to keep inference costs low."
  },
  {
    q: "Who owns the source code, architecture, and IP?",
    a: "You own 100% of all intellectual property, source code, designs, and infrastructure configurations from day one. Everything is pushed directly to your private GitHub/GitLab repositories and deployed to your own cloud infrastructure."
  },
  {
    q: "What are your pricing structures and engagement options?",
    a: "We provide clear, transparent models tailored to your stage: Fixed-Scope Sprints for well-defined MVPs and feature builds, Milestone-Based Delivery for end-to-end product launches, and Dedicated Engineering Retainers for continuous scaling. Every model includes bi-weekly demos and open backlogs."
  },
  {
    q: "How do you keep us updated during development?",
    a: "We work as an extension of your team. You get direct access to our engineers via dedicated Slack/Discord channels, weekly sprint demos, asynchronous video walkthroughs, and real-time visibility into GitHub pull requests and project boards."
  },
  {
    q: "What support do you provide after the product is launched?",
    a: "Every launch comes with an included hypercare warranty period for live monitoring, immediate bug fixes, and performance tuning. Following launch, we offer tailored SLA support packages for feature iterations, security updates, and cloud cost optimization."
  }
];
